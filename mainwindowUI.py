...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.la_header, 3, 0, 1, 1)
        self.gridLayout_3 = QtWidgets.QGridLayout()
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.chb_agc = BuddyCheckBox(self.sidewdg)
        self.chb_agc.setObjectName("chb_agc")
        self.gridLayout_3.addWidget(self.chb_agc, 11, 0, 1, 1)
        self.chb_rean = BuddyCheckBox(self.sidewdg)
        self.chb_rean.setObjectName("chb_rean")
        self.gridLayout_3.addWidget(self.chb_rean, 9, 2, 1, 1)
        self.chb_trp = BuddyCheckBox(self.sidewdg)
        self.chb_trp.setObjectName("chb_trp")
        self.gridLayout_3.addWidget(self.chb_trp, 3, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.la_lab, 0, 0, 1, 1)
        self.chb_ddm = BuddyCheckBox(self.sidewdg)
        self.chb_ddm.setCheckable(True)
        self.chb_ddm.setObjectName("chb_ddm")
        self.gridLayout_3.addWidget(self.chb_ddm, 4, 0, 1, 1)
        self.chb_surg = BuddyCheckBox(self.sidewdg)
        self.chb_surg.setObjectName("chb_surg")
        self.gridLayout_3.addWidget(self.chb_surg, 10, 2, 1, 1)
        self.chb_glu = BuddyCheckBox(self.sidewdg)
        self.chb_glu.setObjectName("chb_glu")
        self.gridLayout_3.addWidget(self.chb_glu, 5, 0, 1, 1)
        self.chb_urol = BuddyCheckBox(self.sidewdg)
        self.chb_urol.setObjectName("chb_urol")
        self.gridLayout_3.addWidget(self.chb_urol, 11, 2, 1, 1)
        self.la_exam = QtWidgets.QLabel(self.sidewdg)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.la_exam.setFont(font)
        self.la_exam.setObjectName("la_exam")
        self.gridLayout_3.addWidget(self.la_exam, 6, 2, 1, 1)
        self.chb_oam = BuddyCheckBox(self.sidewdg)
        self.chb_oam.setObjectName("chb_oam")
        self.gridLayout_3.addWidget(self.chb_oam, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.la_instr, 0, 2, 1, 1)
        self.chb_bak = BuddyCheckBox(self.sidewdg)
        self.chb_bak.setObjectName("chb_bak")
        self.gridLayout_3.addWidget(self.chb_bak, 2, 0, 1, 1)
        self.chb_cts = BuddyCheckBox(self.sidewdg)
        self.chb_cts.setObjectName("chb_cts")
        self.gridLayout_3.addWidget(self.chb_cts, 2, 2, 1, 1)
        self.chb_acb = BuddyCheckBox(self.sidewdg)
        self.chb_acb.setObjectName("chb_acb")
        self.gridLayout_3.addWidget(self.chb_acb, 8, 0, 1, 1)
        self.chb_end = BuddyCheckBox(self.sidewdg)
        self.chb_end.setObjectName("chb_end")
        self.gridLayout_3.addWidget(self.chb_end, 4, 2, 1, 1)
        self.chb_dia = BuddyCheckBox(self.sidewdg)
        self.chb_dia.setObjectName("chb_dia")
        self.gridLayout_3.addWidget(self.chb_dia, 7, 0, 1, 1)
        self.chb_xra = BuddyCheckBox(self.sidewdg)
        self.chb_xra.setEnabled(True)
        self.chb_xra.setObjectName("chb_xra")
        self.gridLayout_3.addWidget(self.chb_xra, 1, 2, 1, 1)
        self.line_6 = QtWidgets.QFrame(self.sidewdg)
        self.line_6.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_6.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_6.setObjectName("line_6")
        self.gridLayout_3.addWidget(self.line_6, 0, 1, 13, 1)
        self.chb_proc = BuddyCheckBox(self.sidewdg)
        self.chb_proc.setEnabled(True)
        self.chb_proc.setObjectName("chb_proc")
        self.gridLayout_3.addWidget(self.chb_proc, 12, 2, 1, 1)
        self.chb_bnp = BuddyCheckBox(self.sidewdg)
        self.chb_bnp.setObjectName("chb_bnp")
        self.gridLayout_3.addWidget(self.chb_bnp, 9, 0, 1, 1)
        self.chb_card = BuddyCheckBox(self.sidewdg)
        self.chb_card.setObjectName("chb_card")
        self.gridLayout_3.addWidget(self.chb_card, 8, 2, 1, 1)
        self.chb_psp = BuddyCheckBox(self.sidewdg)
        self.chb_psp.setObjectName("chb_psp")
        self.gridLayout_3.addWidget(self.chb_psp, 10, 0, 1, 1)
        self.chb_oak = BuddyCheckBox(self.sidewdg)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.chb_oak.setFont(font)
        self.chb_oak.setObjectName("chb_oak")
        self.gridLayout_3.addWidget(self.chb_oak, 1, 0, 1, 1)
        self.chb_usd = BuddyCheckBox(self.sidewdg)
        self.chb_usd.setObjectName("chb_usd")
        self.gridLayout_3.addWidget(self.chb_usd, 3, 2, 1, 1)
        self.chb_abc = BuddyCheckBox(self.sidewdg)
        self.chb_abc.setEnabled(True)
        self.chb_abc.setObjectName("chb_abc")
        self.gridLayout_3.addWidget(self.chb_abc, 12, 0, 1, 1)
        self.chb_neur = BuddyCheckBox(self.sidewdg)
        self.chb_neur.setObjectName("chb_neur")
        self.gridLayout_3.addWidget(self.chb_neur, 7, 2, 1, 1)
        ...
        self.gb_notifytype = QtWidgets.QGroupBox(self.topwdg)
...
"color: rgb(0, 65, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chb_rean.setText(_translate("MainWindow", "Реаниматолог"))
        self.chb_trp.setText(_translate("MainWindow", "Тропонин"))
        self.la_lab.setText(_translate("MainWindow", "Лабораторные:"))
        self.chb_ddm.setText(_translate("MainWindow", "D-димер"))
        self.chb_surg.setText(_translate("MainWindow", "Хирург"))
        self.chb_glu.setText(_translate("MainWindow", "Глюкоза (перифер.)"))
        self.chb_urol.setText(_translate("MainWindow", "Уролог"))
        self.la_exam.setText(_translate("MainWindow", "Осмотры:"))
        ...
        self.chb_dia.setText(_translate("MainWindow", "Диастаза мочи"))
        self.chb_xra.setText(_translate("MainWindow", "Рентгенография"))
        self.chb_proc.setText(_translate("MainWindow", "Проктолог"))
        self.chb_bnp.setText(_translate("MainWindow", "proBNP"))
        self.chb_card.setText(_translate("MainWindow", "Кардиолог"))
        ...
        self.chb_neur.setText(_translate("MainWindow", "Невролог"))
